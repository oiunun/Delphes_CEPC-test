...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Track*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Track", ::Track::Class_Version(), "classes/DelphesClasses.h", 430,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Tower*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Tower", ::Tower::Class_Version(), "classes/DelphesClasses.h", 518,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ParticleFlowCandidate*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("ParticleFlowCandidate", ::ParticleFlowCandidate::Class_Version(), "classes/DelphesClasses.h", 552,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HectorHit*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("HectorHit", ::HectorHit::Class_Version(), "classes/DelphesClasses.h", 650,
...
namespace ROOT {
   static void *new_CscCluster(void *p = 0);
   static void *newArray_CscCluster(Long_t size, void *p);
   static void delete_CscCluster(void *p);
   static void deleteArray_CscCluster(void *p);
   static void destruct_CscCluster(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CscCluster*)
   {
      ::CscCluster *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::CscCluster >(0);
      static ::ROOT::TGenericClassInfo 
         instance("CscCluster", ::CscCluster::Class_Version(), "classes/DelphesClasses.h", 673,
                  typeid(::CscCluster), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::CscCluster::Dictionary, isa_proxy, 4,
                  sizeof(::CscCluster) );
      instance.SetNew(&new_CscCluster);
      instance.SetNewArray(&newArray_CscCluster);
      instance.SetDelete(&delete_CscCluster);
      instance.SetDeleteArray(&deleteArray_CscCluster);
      instance.SetDestructor(&destruct_CscCluster);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::CscCluster*)
   {
      return GenerateInitInstanceLocal((::CscCluster*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::CscCluster*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Candidate*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Candidate", ::Candidate::Class_Version(), "classes/DelphesClasses.h", 703,
...
//______________________________________________________________________________
atomic_TClass_ptr CscCluster::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *CscCluster::Class_Name()
{
   return "CscCluster";
}

//______________________________________________________________________________
const char *CscCluster::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CscCluster*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int CscCluster::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CscCluster*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *CscCluster::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CscCluster*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *CscCluster::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CscCluster*)0x0)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void CscCluster::Streamer(TBuffer &R__b)
{
   // Stream an object of class CscCluster.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(CscCluster::Class(),this);
   } else {
      R__b.WriteClassBuffer(CscCluster::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_CscCluster(void *p) {
      return  p ? new(p) ::CscCluster : new ::CscCluster;
   }
   static void *newArray_CscCluster(Long_t nElements, void *p) {
      return p ? new(p) ::CscCluster[nElements] : new ::CscCluster[nElements];
   }
   // Wrapper around operator delete
   static void delete_CscCluster(void *p) {
      delete ((::CscCluster*)p);
   ...
   static void destruct_CscCluster(void *p) {
      typedef ::CscCluster current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::CscCluster
...
class __attribute__((annotate("$clingAutoload$classes/DelphesClasses.h")))  CscCluster;
