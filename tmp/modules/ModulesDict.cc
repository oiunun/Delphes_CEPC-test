...
namespace ROOT {
   static void *new_UnstablePropagator(void *p = 0);
   static void *newArray_UnstablePropagator(Long_t size, void *p);
   static void delete_UnstablePropagator(void *p);
   static void deleteArray_UnstablePropagator(void *p);
   static void destruct_UnstablePropagator(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::UnstablePropagator*)
   {
      ::UnstablePropagator *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::UnstablePropagator >(0);
      static ::ROOT::TGenericClassInfo 
         instance("UnstablePropagator", ::UnstablePropagator::Class_Version(), "modules/UnstablePropagator.h", 38,
                  typeid(::UnstablePropagator), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::UnstablePropagator::Dictionary, isa_proxy, 4,
                  sizeof(::UnstablePropagator) );
      instance.SetNew(&new_UnstablePropagator);
      instance.SetNewArray(&newArray_UnstablePropagator);
      instance.SetDelete(&delete_UnstablePropagator);
      instance.SetDeleteArray(&deleteArray_UnstablePropagator);
      instance.SetDestructor(&destruct_UnstablePropagator);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::UnstablePropagator*)
   {
      return GenerateInitInstanceLocal((::UnstablePropagator*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::UnstablePropagator*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TrackCovariance*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TrackCovariance", ::TrackCovariance::Class_Version(), "modules/TrackCovariance.h", 41,
...
namespace ROOT {
   static void *new_LLPFilter(void *p = 0);
   static void *newArray_LLPFilter(Long_t size, void *p);
   static void delete_LLPFilter(void *p);
   static void deleteArray_LLPFilter(void *p);
   static void destruct_LLPFilter(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::LLPFilter*)
   {
      ::LLPFilter *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::LLPFilter >(0);
      static ::ROOT::TGenericClassInfo 
         instance("LLPFilter", ::LLPFilter::Class_Version(), "modules/LLPFilter.h", 41,
                  typeid(::LLPFilter), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::LLPFilter::Dictionary, isa_proxy, 4,
                  sizeof(::LLPFilter) );
      instance.SetNew(&new_LLPFilter);
      instance.SetNewArray(&newArray_LLPFilter);
      instance.SetDelete(&delete_LLPFilter);
      instance.SetDeleteArray(&deleteArray_LLPFilter);
      instance.SetDestructor(&destruct_LLPFilter);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::LLPFilter*)
   {
      return GenerateInitInstanceLocal((::LLPFilter*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::LLPFilter*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

namespace ROOT {
   static void *new_CscClusterEfficiency(void *p = 0);
   static void *newArray_CscClusterEfficiency(Long_t size, void *p);
   static void delete_CscClusterEfficiency(void *p);
   static void deleteArray_CscClusterEfficiency(void *p);
   static void destruct_CscClusterEfficiency(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CscClusterEfficiency*)
   {
      ::CscClusterEfficiency *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::CscClusterEfficiency >(0);
      static ::ROOT::TGenericClassInfo 
         instance("CscClusterEfficiency", ::CscClusterEfficiency::Class_Version(), "modules/CscClusterEfficiency.h", 38,
                  typeid(::CscClusterEfficiency), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::CscClusterEfficiency::Dictionary, isa_proxy, 4,
                  sizeof(::CscClusterEfficiency) );
      instance.SetNew(&new_CscClusterEfficiency);
      instance.SetNewArray(&newArray_CscClusterEfficiency);
      instance.SetDelete(&delete_CscClusterEfficiency);
      instance.SetDeleteArray(&deleteArray_CscClusterEfficiency);
      instance.SetDestructor(&destruct_CscClusterEfficiency);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::CscClusterEfficiency*)
   {
      return GenerateInitInstanceLocal((::CscClusterEfficiency*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::CscClusterEfficiency*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

namespace ROOT {
   static void *new_CscClusterId(void *p = 0);
   static void *newArray_CscClusterId(Long_t size, void *p);
   static void delete_CscClusterId(void *p);
   static void deleteArray_CscClusterId(void *p);
   static void destruct_CscClusterId(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CscClusterId*)
   {
      ::CscClusterId *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::CscClusterId >(0);
      static ::ROOT::TGenericClassInfo 
         instance("CscClusterId", ::CscClusterId::Class_Version(), "modules/CscClusterId.h", 36,
                  typeid(::CscClusterId), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::CscClusterId::Dictionary, isa_proxy, 4,
                  sizeof(::CscClusterId) );
      instance.SetNew(&new_CscClusterId);
      instance.SetNewArray(&newArray_CscClusterId);
      instance.SetDelete(&delete_CscClusterId);
      instance.SetDeleteArray(&deleteArray_CscClusterId);
      instance.SetDestructor(&destruct_CscClusterId);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::CscClusterId*)
   {
      return GenerateInitInstanceLocal((::CscClusterId*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::CscClusterId*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
atomic_TClass_ptr UnstablePropagator::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *UnstablePropagator::Class_Name()
{
   return "UnstablePropagator";
}

//______________________________________________________________________________
const char *UnstablePropagator::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::UnstablePropagator*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int UnstablePropagator::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::UnstablePropagator*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *UnstablePropagator::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::UnstablePropagator*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *UnstablePropagator::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::UnstablePropagator*)0x0)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
atomic_TClass_ptr LLPFilter::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *LLPFilter::Class_Name()
{
   return "LLPFilter";
}

//______________________________________________________________________________
const char *LLPFilter::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::LLPFilter*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int LLPFilter::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::LLPFilter*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *LLPFilter::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::LLPFilter*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *LLPFilter::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::LLPFilter*)0x0)->GetClass(); }
   return fgIsA;
}

//______________________________________________________________________________
atomic_TClass_ptr CscClusterEfficiency::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *CscClusterEfficiency::Class_Name()
{
   return "CscClusterEfficiency";
}

//______________________________________________________________________________
const char *CscClusterEfficiency::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CscClusterEfficiency*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int CscClusterEfficiency::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CscClusterEfficiency*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *CscClusterEfficiency::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CscClusterEfficiency*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *CscClusterEfficiency::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CscClusterEfficiency*)0x0)->GetClass(); }
   return fgIsA;
}

//______________________________________________________________________________
atomic_TClass_ptr CscClusterId::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *CscClusterId::Class_Name()
{
   return "CscClusterId";
}

//______________________________________________________________________________
const char *CscClusterId::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CscClusterId*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int CscClusterId::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CscClusterId*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *CscClusterId::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CscClusterId*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *CscClusterId::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CscClusterId*)0x0)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void UnstablePropagator::Streamer(TBuffer &R__b)
{
   // Stream an object of class UnstablePropagator.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(UnstablePropagator::Class(),this);
   } else {
      R__b.WriteClassBuffer(UnstablePropagator::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_UnstablePropagator(void *p) {
      return  p ? new(p) ::UnstablePropagator : new ::UnstablePropagator;
   }
   static void *newArray_UnstablePropagator(Long_t nElements, void *p) {
      return p ? new(p) ::UnstablePropagator[nElements] : new ::UnstablePropagator[nElements];
   }
   // Wrapper around operator delete
   static void delete_UnstablePropagator(void *p) {
      delete ((::UnstablePropagator*)p);
   }
   static void deleteArray_UnstablePropagator(void *p) {
      delete [] ((::UnstablePropagator*)p);
   }
   static void destruct_UnstablePropagator(void *p) {
      typedef ::UnstablePropagator current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::UnstablePropagator
...
//______________________________________________________________________________
void LLPFilter::Streamer(TBuffer &R__b)
{
   // Stream an object of class LLPFilter.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(LLPFilter::Class(),this);
   } else {
      R__b.WriteClassBuffer(LLPFilter::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_LLPFilter(void *p) {
      return  p ? new(p) ::LLPFilter : new ::LLPFilter;
   }
   static void *newArray_LLPFilter(Long_t nElements, void *p) {
      return p ? new(p) ::LLPFilter[nElements] : new ::LLPFilter[nElements];
   }
   // Wrapper around operator delete
   static void delete_LLPFilter(void *p) {
      delete ((::LLPFilter*)p);
   ...
   static void destruct_LLPFilter(void *p) {
      typedef ::LLPFilter current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::LLPFilter

//______________________________________________________________________________
void CscClusterEfficiency::Streamer(TBuffer &R__b)
{
   // Stream an object of class CscClusterEfficiency.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(CscClusterEfficiency::Class(),this);
   } else {
      R__b.WriteClassBuffer(CscClusterEfficiency::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_CscClusterEfficiency(void *p) {
      return  p ? new(p) ::CscClusterEfficiency : new ::CscClusterEfficiency;
   }
   static void *newArray_CscClusterEfficiency(Long_t nElements, void *p) {
      return p ? new(p) ::CscClusterEfficiency[nElements] : new ::CscClusterEfficiency[nElements];
   }
   // Wrapper around operator delete
   static void delete_CscClusterEfficiency(void *p) {
      delete ((::CscClusterEfficiency*)p);
   }
   static void deleteArray_CscClusterEfficiency(void *p) {
      delete [] ((::CscClusterEfficiency*)p);
   }
   static void destruct_CscClusterEfficiency(void *p) {
      typedef ::CscClusterEfficiency current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::CscClusterEfficiency

//______________________________________________________________________________
void CscClusterId::Streamer(TBuffer &R__b)
{
   // Stream an object of class CscClusterId.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(CscClusterId::Class(),this);
   } else {
      R__b.WriteClassBuffer(CscClusterId::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_CscClusterId(void *p) {
      return  p ? new(p) ::CscClusterId : new ::CscClusterId;
   }
   static void *newArray_CscClusterId(Long_t nElements, void *p) {
      return p ? new(p) ::CscClusterId[nElements] : new ::CscClusterId[nElements];
   }
   // Wrapper around operator delete
   static void delete_CscClusterId(void *p) {
      delete ((::CscClusterId*)p);
   }
   static void deleteArray_CscClusterId(void *p) {
      delete [] ((::CscClusterId*)p);
   }
   static void destruct_CscClusterId(void *p) {
      typedef ::CscClusterId current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::CscClusterId
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const deque<double>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("deque<double>", -2, "deque", 764,
...
class __attribute__((annotate("$clingAutoload$modules/UnstablePropagator.h")))  UnstablePropagator;
...
class __attribute__((annotate("$clingAutoload$modules/LLPFilter.h")))  LLPFilter;
class __attribute__((annotate("$clingAutoload$modules/CscClusterEfficiency.h")))  CscClusterEfficiency;
class __attribute__((annotate("$clingAutoload$modules/CscClusterId.h")))  CscClusterId;
)DICTFWDDCLS";
...
"CscClusterEfficiency", payloadCode, "@",
"CscClusterId", payloadCode, "@",
...
"UnstablePropagator", payloadCode, "@",
